...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    $sql_query = "UPDATE cars SET title='$title', slug='$slug', meta='$meta', h1='$h1', h1_about='$h1_about', h2='$h2', h2_about='$h2_about', content='$content', car_models='$car_models' where id = '$id'";
