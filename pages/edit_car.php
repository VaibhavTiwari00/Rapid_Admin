<?php
    ...
    if (isset($_GET['_id']) && !empty($_GET['_id'])) {
        ...
        if (!is_data_exist('cars', "`id` = '$_id'")) {
            $error = "Faild";
        } else {
            $sql = "SELECT * FROM `cars` WHERE `id` = '$_id'";
            $car = fetch_data($sql);
        }
    } else {
        $error = "Failed";
...
<body>
    ...
    <main>
        <form action="<?=home_path()?>/services/cars/edit.php" method="post">
            <div class="right-section-car">
                ...
                <div class="page-header">
                    ...
                    <p class="page-header-heading"> Edit Car </p>
                ...
                <section>
                    <div>
                        <div class="box-1">
                            ...
                            <input type="text" name="title" id="title" value="<?= $car['title'];?>">

                            <p class="input-lable"> Slug: </p>
                            <input type="text" name="slug" id="slug" value="<?= $car['slug'];?>">



                            <p class="input-lable">Meta Tags:</p>
                            <textarea type="text" name="meta" id="meta-tags" rows="12"> <?= $car['meta'];?></textarea>
                        </div>
                ...
                <div class="box-1">
                 ...
                 <input type="text" id="heading"> -->
                    ...
                    <textarea name="content" id="content"><?= $car['content'];?></textarea>


                </div>
                <div class="box-1">
                    <p class="input-lable"> Car: </p>
