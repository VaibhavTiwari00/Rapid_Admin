...
$query_to_fetch_states = "SELECT * FROM `cars`";
$car_list = fetch_all_data($query_to_fetch_states);
...
<body>
    ...
    <main>
        ...
        <div class="page-header">
            ...
            <p class="page-header-heading"> Cars (<?= isset($car_list) ?  count($car_list) : 0 ?>) </p>


            <div class="page-header-btn-container">
                <input type="text" name="" id="search" placeholder="Search" onkeyup="serach_data(this.value)">
                <a href="<?= home_path() . '/cars/add'  ?>" class="btn-yellow-1">Add Cars</a>
                    ...
                    if(isset($car_list)){
                        foreach($car_list as $row){ ;?>
                            <tr>
                                ...
                                <td><button class="view_btn"><a href="https://rapidautoshipping.com/cars/<?= $row['slug'] ?>">View</a></button> <button class="edit_btn"><a href="<?= home_path() . "/cars/edit/" . $row['id'];?>">Edit</a></button></td>
                            </tr>
                           <?php }
                    }else{ ; ?>
                        <tr>
