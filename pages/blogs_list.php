                    ...
                    if(isset($blogs_list)){
                        foreach($blogs_list as $row){ ;?>
                            <tr>
                                ...
                                <td><button class="view_btn"><a href="https://rapidautoshipping.com/blogs/<?= $row['slug'] ?>">View</a></button> <button class="edit_btn"><a href="<?= home_path() . "/blogs/edit/" . $row['id'];?>">Edit</a></button></td>
                            </tr>
                           <?php }
                    }else{ ; ?>
                        <tr>
