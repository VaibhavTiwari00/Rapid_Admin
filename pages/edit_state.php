<?php
    ...
    if (isset($_GET['_id']) && !empty($_GET['_id'])) {
        ...
        if (!is_data_exist('states', "`id` = '$_id'")) {
            $error = "Faild";
        } else {
            $sql = "SELECT * FROM `states` WHERE `id` = '$_id'";
...
<body>
    ...
    <main>
        <form action="<?=home_path()?>/services/states/edit.php" method="post">
           <div class="right-section-state">
            ...
            <div class="page-header">
                ...
                <p class="page-header-heading"> Edit State </p>
                <div class="page-header-btn-container">

                    <button class="btn-yellow-1" id="save-page-btn"> Save State</button>
            ...
            <section>
                <div>
                    <div class="box-1">
                        ...
                        <input type="text" name="slug" id="slug" value="<?= $state['slug'];?>">



                        <p class="input-lable">Meta Tags:</p>
                        <textarea type="text" name="meta" id="meta-tags" rows="12"> <?= $state['meta'];?></textarea>
                    </div>
                ...
                <div>
                    <div class="box-1">
                        ...
                        <input type="text" name="h1" id="page-h1" value="<?= $state['h1'];?>">

                        <p class="input-lable"> About-1: </p>
                        <textarea type="text" name="h1_about" id="about-1" rows="12"><?= $state['h1_about'];?></textarea>

                        <p class="input-lable"> Page-h2: </p>
                        <input type="text" name="h2" id="page-h2" value="<?= $state['h2'];?>">

                        <p class="input-lable"> About-2: </p>
                        <textarea type="text" name="h2_about" id="about-2" rows="12"><?= $state['h2_about'];?></textarea>
            ...
            <div class="box-1">
                ...
                <textarea name="content" id="content"><?= $state['content'];?></textarea>


            </div>
            <div class="box-1">
                 <p class="input-lable"> City: </p>
                 <input type="text" id="city">

                 <p class="input-lable"> Zip Code : </p>
                 <input type="text" id="zip_code">
                 <input type="hidden" id="city_zip" name="city_zip" value="">
                 

                 <div class="btn-state">
                     <button class="btn-yellow-1" id="add_city">Add City</button>
                 </div>
             </div>
    ...
    <script>
        let note_site = `<?= $state['city_zipcode'] ?>`;
         ...
         function add_data() {
             ...
             let heading = document.getElementById('city'),
                 about = zip_code.value;
             if (heading.value == '' || about == '') {
                 toast.error("Please enter City or Zip code")
                 return;
             }
         ...
         function edit_note(i) {
             note_index = i
             console.log(i);
             document.getElementById('city').value = note[i].city
             zip_code.value = note[i].zip_code
         }
